...
RSpec.describe AddressBook do
    ...
    describe "attributes" do
        ...
        it "initialized entries as an array" do
    ...
    describe "#remove_entry" do
        ...
        it "removes an entry using the name, phone_number, and email address" do
            book.add_entry("Thomas Tone", "010.867.5309", "tommy2@goturnumber.com")
            ...
            expect(book.entries.first.name).to eq("Thomas Tone")
        end
      end
    ...
    describe "#import_from_csv" do
        it "imports the correct number of entries" do
            ...
            if book.import_from_csv("entries.csv")
            book_size = book.entries.size
            expect(book_size).to eq 5
            
            else book.import_from_csv("entries_2.csv")
            book_size = book.entries.size
        ...
        it "imports the 1st entry" do
            ...
            check_entry(entry_one, "Cody", "555-555-4125", "cody@blocmail.com")
        end
        ...
        it "imports the 2nd entry" do
            ...
            check_entry(entry_two, "Marley", "555-555-9900", "marley@blocmail.com")
        end
        ...
        it "imports the 3rd entry" do
            ...
            check_entry(entry_three, "Zax", "555-555-3246", "zax@blocmail.com")
        end
